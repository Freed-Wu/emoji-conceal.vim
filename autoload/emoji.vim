" https://raw.githubusercontent.com/markdown-templates/markdown-emojis/master/emojis.json
...
let s:emoji_dict = {
      ...
      \ }
function! emoji#conceal() abort
  for [s:name, s:emoji] in items(s:emoji_dict)
